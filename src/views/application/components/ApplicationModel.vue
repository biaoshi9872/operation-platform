        ...
        <el-form-item label="项目类型" prop="projectType">
          <template #label>
            <el-tooltip effect="dark" placement="top">
              <template #content>
                <div> 1、金融API项目：项目盈利模式为赚差价，收入计算基准为分销价；
                  若项目特殊设置盈利模式为扣点模式，请线下对账。</div>
                <div> 2、企业（福利）API项目：项目盈利模式为赚差价，收入计算基准为分销价；若项目特殊设置盈利模式为扣点模式，请线下对账。</div>
                <div> 3、礼业合作API项目：项目盈利模式为扣点模式，收入计算基准为平台供应价；若项目特殊设置盈利模式为赚差价，请线下对账。</div>
              </template>
