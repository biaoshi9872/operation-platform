...
<template>
  <el-dialog v-bind="$attrs" width="500px" title="重置密码" destroy-on-close :close-on-click-modal="false"
    @closed="handleReset" draggable>
    <el-form ref="form" label-width="140px" label-suffix="：" :model="formData" :rules="formRules">
      ...
      <el-form-item label="确认密码" prop="confirmPassword">
        <el-input v-model="formData.confirmPassword" placeholder="请输入6位数以上字母+数字密码" show-password clearable
          maxlength="20" />
      </el-form-item>
    </el-form>
