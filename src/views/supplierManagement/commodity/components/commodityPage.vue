            ...
            <el-form :model="dataInfo.form" ref="formRef" label-width="120px" :rules="rules" :disabled="isDisabled">
                ...
                <el-card shadow="never" class="mb-8">
                    ...
                    <el-form-item label="市场价" prop="markPrice" required>
                        <el-input-number v-model="dataInfo.form.markPrice" max="99999999.99" :controls="false" :min="0"
                    ...
                    <el-form-item label="库存数量" prop="stock" required>
                        <el-input-number v-model="dataInfo.form.stock" :controls="false" :min="0" :max="999999999"
                            :precision="0" />
                    </el-form-item>
