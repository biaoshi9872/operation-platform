  ...
  <PageContainer v-loading="dataPage.loadingData">
    ...
    >
      ...
      <el-form-item label="渠道售后单编号" class="formItem" placeholder="请选择">
        <el-input v-model.trim="dataPage.facade.thirdAfterSaleNo" placeholder="请输入渠道售后单编号"></el-input>
      </el-form-item>
      ...
      <el-form-item label="分销渠道" class="formItem" placeholder="请选择">
        <!-- <ChannelSelect v-model.trim="dataPage.facade.merchantNo" placeholder="请选择分销渠道"></ChannelSelect> -->
        <ChannelCascadeSelect
          v-model="dataPage.facade.channelCodeListModel"
          v-model:dataList="dataPage.facade.merchantNo"
          placeholder="请输入分销渠道"
        ></ChannelCascadeSelect>
      </el-form-item>
      <!-- <el-form-item label="面单是否脱敏" class="formItem" placeholder="请选择">
        <SelectModel v-model.trim="dataPage.facade.desensitizationStatus" :selectList="ycb_bulkOrder_enum.E_MianDanShiFouTuoMin"></SelectModel>
      </el-form-item>-->
    </SearchForm>
    <OrderCustomTable
      ...
      <template #customRow="{ row }">
        <div class="order_row">
          <div class="order_detail">
            ...
            <span class="thirdOrderNo">渠道售后单编号:{{ row.thirdAfterSaleNo || '-' }}</span>
